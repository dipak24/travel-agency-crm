...
class ServiceResource extends Resource
{
 ...
 public static function table(Table $table): Table { return $table->columns([TextColumn::make('name')->searchable()->sortable(),TextColumn::make('price'),TextColumn::make('currency'),IconColumn::make('is_active')->boolean(),IconColumn::make('has_limited_availability')->label('Limited')->boolean()])->recordActions([EditAction::make(),DeleteAction::make()]); }
