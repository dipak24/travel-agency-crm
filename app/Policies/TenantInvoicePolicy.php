...
class TenantInvoicePolicy
{
    ...
    public function view(SuperAdmin $user, TenantInvoice $invoice): bool
    {
        return $this->hasPermission($user);
    }
    ...
    public function update(SuperAdmin $user, TenantInvoice $invoice): bool
    {
        return $this->hasPermission($user);
    }

    public function delete(SuperAdmin $user, TenantInvoice $invoice): bool
    {
        return $this->hasPermission($user);
    }

    public function restore(SuperAdmin $user, TenantInvoice $invoice): bool
    {
        return $this->hasPermission($user);
    }
